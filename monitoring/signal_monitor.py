...
def filter_trading_signals(lines):
    ...
    signal_keywords = [
        "SIGNAL", "BUY", "SELL", "ORDER", "EXECUTION", "FILLED",
        "CYCLE", "SCANNING", "GENERATED", "PLACED", "CANCELLED",
        "PROFIT", "STOP", "TRAIL", "POSITION", "ENTRY", "EXIT"
    ]
    ...
    for line in lines:
        if any(keyword in line.upper() for keyword in signal_keywords):
            ...
            if "10:" in line or "11:" in line or "12:" in line or "13:" in line or "14:" in line or "15:" in line:
...
def main():
    ...
    while True:
        ...
        trail_logs = get_latest_log_content(f"intraday_trailing_stop_manager_{today}.log", 30)
