...
def test_command_center_initialization():
    ...
    try:
        ...
        print(f"✅ Alpaca connector: {'Available' if cc.alpaca_connector else 'Not available'}")
        print(f"✅ Confidence calculator: {'Available' if cc.confidence_calculator else 'Not available'}")
