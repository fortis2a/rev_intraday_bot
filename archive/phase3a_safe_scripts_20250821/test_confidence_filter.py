...
def test_confidence_filter():
    ...
    print(f"Original Watchlist: {len(filtered_original)}/{len(original_watchlist)} passed")
    ...
    failed_stocks = [(s, confidence_results[s]) for s in all_stocks if confidence_results[s] < 75.0]
    if failed_stocks:
