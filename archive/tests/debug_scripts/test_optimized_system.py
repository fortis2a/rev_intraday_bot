...
def test_unified_indicator_service():
    ...
    try:
        ...
        for strategy in strategies:
            ...
            result = unified_indicator_service.get_indicators_for_strategy(df, 'AAPL', strategy)
            end_time = time.time()
            ...
            print(f"✅ Generated {len(indicators)} indicators in {(end_time-start_time)*1000:.1f}ms")
