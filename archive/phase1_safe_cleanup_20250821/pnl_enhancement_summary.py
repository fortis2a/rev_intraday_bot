...
def show_pnl_enhancement_summary():
    ...
    print(f"💡 Match: {sample_analysis['total_actual_pnl'] == sample_analysis['total_cash_flow']} (single-day positions)")
    print()
    
    print("⏰ HOURLY P&L BREAKDOWN:")
    print(f"{'Hour':<6} {'Actual P&L':<12} {'Cash Flow':<12} {'Trades':<8} {'Volume %':<10}")
    ...
    for hour, actual, cash, trades, vol_pct in sample_analysis['hourly_breakdown']:
        ...
        print(f"{hour:<6} ${actual:<11.2f} ${cash:<11.2f} {trades:<8} {vol_pct:<10} {actual_icon}")
    ...
    print("💰 Actual P&L • ✅ Includes Fees • 📊 Multi-day Positions • ⏰ Volume-weighted")
