...
def run_diagnostics():
    ...
    try:
        ...
        key_params = [
            'CHECK_INTERVAL', 'TIMEFRAME', 'MAX_POSITIONS', 
            'POSITION_SIZE', 'RISK_PER_TRADE', 'MAX_DAILY_LOSS'
        ]
        ...
        try:
            ...
            import subprocess
            result = subprocess.run(['powershell', '-Command', 'Get-Process | Where-Object {$_.ProcessName -eq "python"} | Select-Object Id, ProcessName'], 
        ...
        for log_file in log_files:
            ...
            if os.path.exists(path):
                ...
                if age_minutes > 60:
                    print(f"   ⚠️  WARNING: Log not updated in {age_minutes:.0f} minutes")
            else:
