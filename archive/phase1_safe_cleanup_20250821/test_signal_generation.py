    ...
    for symbol in test_symbols:
        ...
        try:
            ...
            if (
                ...
                print(
                    f"  ❌ Price outside limits (${config['MIN_PRICE']}-${config['MAX_PRICE']})"
                )
                continue
            ...
            try:
                ...
                if momentum_signal:
                    print(
                        f"  🚀 MOMENTUM SIGNAL: {momentum_signal['action']} - {momentum_signal['reason']}"
                    )
                else:
            ...
            try:
                ...
                if mean_rev_signal:
                    print(
                        f"  📈 MEAN REVERSION SIGNAL: {mean_rev_signal['action']} - {mean_rev_signal['reason']}"
                    )
                else:
