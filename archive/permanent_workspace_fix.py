...
def organize_files():
    ...
    file_moves = {
        ...
        # Batch files
        'batch_files/': [
            file for file in os.listdir('.') if file.endswith('.bat')
        ] + [
        ...
        # Utilities
        'utilities/': [
            file for file in os.listdir('.') if file.startswith('organize_') and file.endswith('.py')
        ] + [
            file for file in os.listdir('.') if file.startswith('phase') and file.endswith('.py')
        ] + [
        ...
        # Tests
        'tests/': [
            file for file in os.listdir('.') if file.startswith('test_') and file.endswith('.py')
        ],
        
        # Archive old files
        'archive/': [
            file for file in os.listdir('.') if file.startswith('debug_') and file.endswith('.py')
        ] + [
            file for file in os.listdir('.') if file.startswith('check_') and file.endswith('.py')
        ] + [
            file for file in os.listdir('.') if file.startswith('verify_') and file.endswith('.py')
        ]
    }
