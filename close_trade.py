...
class TradeCloser:
    ...
    def list_open_positions(self):
        ...
        try:
            ...
            for i, position in enumerate(positions, 1):
                ...
                pnl_pct = (unrealized_pnl / (entry_price * qty)) * 100 if entry_price * qty != 0 else 0
    ...
    def close_position(self, symbol):
        ...
        try:
            ...
            # Confirm closure
            confirm = input(f"\n⚠️  Are you sure you want to close {symbol}? (y/N): ").strip().lower()
    ...
    def close_all_positions(self):
        ...
        try:
            ...
            confirm = input(f"\n⚠️  Are you sure you want to close ALL positions? (y/N): ").strip().lower()
...
def main():
    ...
    parser.add_argument('--list', '-l', action='store_true', help='List all open positions')
