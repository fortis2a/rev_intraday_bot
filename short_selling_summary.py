...
def test_short_selling_implementation():
    ...
    print(f"   ✅ SHORT_SELLING_MIN_CONFIDENCE: {config.get('SHORT_SELLING_MIN_CONFIDENCE', 75.0)}%")
    print(f"   ✅ SHORT_SELLING_MAX_POSITION_SIZE: ${config.get('SHORT_SELLING_MAX_POSITION_SIZE', 500)}")
    ...
    print(f"   💰 Buying Power: ${data_manager.get_account_info()['buying_power']:,.2f}")
