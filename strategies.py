...
class VWAPStrategy:
    ...
    def generate_signal(self, symbol, df):
        ...
        try:
            ...
            if price_change > 0 and price > vwap:  # Must have positive momentum AND be above VWAP
            ...
            if price_change < 0 and price < vwap:  # Must have negative momentum AND be below VWAP
