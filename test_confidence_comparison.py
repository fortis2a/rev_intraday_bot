...
def test_confidence_systems():
    ...
    try:
        ...
        for name, strategy in strategies.items():
            ...
            if signal:
                print(f'   ✅ {name}: {signal["action"]} at {signal["confidence"]:.1%} confidence')
    ...
    print('   ✅ Risk Management: Built into both systems with stock-specific thresholds')
    ...
    print('   🚀 Mean Reversion: RSI, Bollinger Bands, EMA, MACD, Stochastic, Support/Resistance')
    print('   ⚡ Momentum Scalp: Multi-EMA, MACD, ADX, Williams %R, ROC, VWAP, Volume Flow')
