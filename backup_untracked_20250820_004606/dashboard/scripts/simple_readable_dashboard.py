...
class SimpleReadableDashboard:
    ...
    def create_simple_dashboard(self, output_dir='reports/daily'):
        ...
        try:
            ...
            fig.suptitle('SIMPLE TRADING DASHBOARD - EASY TO READ', 
            ...
            fig.text(0.5, 0.91, summary_text, ha='center', fontsize=24, fontweight='bold')
...
STOCKS TRADED: {total_stocks}
            ...
            dashboard_path = os.path.join(output_dir, f'simple_readable_dashboard_{timestamp}.png')
