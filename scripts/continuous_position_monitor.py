...
class ContinuousPositionMonitor:
        ...
        if side == "long":
            ...
            if current_profit > self.position_highs[symbol]:
                ...
                try:
                    ...
                    self.logger.info(
                        f"[{symbol}] LONG: Updated trailing stop - New high profit: {current_profit:.2f}%"
                    )
            ...
            if current_profit > self.position_highs[symbol]:
                ...
                try:
                    ...
                    self.logger.info(
                        f"[{symbol}] SHORT: Updated trailing stop - New high profit: {current_profit:.2f}%"
                    )
    ...
    def check_take_profit_targets(self, position):
        ...
        take_profit_target = (
            thresholds["take_profit_pct"] * 100
        ...
        if current_profit >= take_profit_target:
            try:
                ...
                self.logger.info(
                    f"[{symbol}] 🎯 TAKE PROFIT EXECUTED at {current_profit:.2f}% "
    ...
    def monitor_positions(self):
        ...
        self.logger.info(
            "Monitoring profitable positions with dynamic trailing stops..."
        )
