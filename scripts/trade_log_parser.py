...
class TradeLogParser:
    ...
    def __init__(self, log_directory: str = None):
        ...
        self.logger.info(f"📊 Trade log parser initialized - monitoring: {self.log_directory}")
    ...
    def parse_trade_from_line(self, line: str, timestamp: datetime = None) -> Optional[TradeExecution]:
        ...
        try:
            ...
            for line in new_lines:
                ...
                if trade:
                    ...
                    self.logger.info(f"📈 New trade detected: {trade.symbol} {trade.action} {trade.quantity}@${trade.price:.2f}")
    ...
    def scan_recent_trades(self, hours_back: int = 24) -> List[TradeExecution]:
        ...
        self.logger.info(f"Found {len(recent_trades)} recent trades in last {hours_back} hours")
        ...
        def monitor_loop():
            while True:
                try:
                    ...
                    new_files = [f for f in current_files if str(f) not in self.file_positions]
    ...
    def update_trade_summary(self):
        ...
        today_trades = [t for t in self.trade_executions 
    ...
    def get_recent_trades(self, limit: int = 50, hours: int = None) -> List[TradeExecution]:
        ...
        if hours is not None:
            ...
            recent_trades = [
                t for t in self.trade_executions 
    ...
    def get_trades_by_strategy(self, strategy: str) -> List[TradeExecution]:
        ...
        return [t for t in self.trade_executions if strategy.lower() in t.strategy.lower()]
