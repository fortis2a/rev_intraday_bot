        ...
        for order_info in protection_orders:
            ...
            try:
                if position_type == 'LONG':
                    ...
                    self.logger.info(f"   ✅ Stop Loss: SELL at ${order_info['trailing_stop']:.2f} (Order: {stop_order.id})")
                    ...
                    self.logger.info(f"   ✅ Take Profit: SELL at ${order_info['take_profit']:.2f} (Order: {profit_order.id})")
                    ...
                    self.logger.info(f"   ✅ Stop Loss: BUY at ${order_info['trailing_stop']:.2f} (Order: {stop_order.id})")
                    ...
                    self.logger.info(f"   ✅ Take Profit: BUY at ${order_info['take_profit']:.2f} (Order: {profit_order.id})")
