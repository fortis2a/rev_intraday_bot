    ...
    try:
        ...
        if positions and len(positions) > 0:
            ...
            if qty != 0:
                ...
                if current_price:
                    print(f"   Testing price update with current price: ${current_price:.2f}")
                    ...
                    activation_threshold = pos_data.entry_price * 1.005  # 0.5% activation
                    print(f"   Activation threshold: ${activation_threshold:.2f}")
                    print(f"   Current price: ${current_price:.2f}")
                    print(f"   Should activate: {current_price >= activation_threshold}")
