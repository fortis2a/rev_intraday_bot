            ...
            try:
                ...
                if not data["positions"]:
                    ...
                    for pos in data["positions"]:
                        ...
                        print(
                            f"   {pos.symbol:<6} {side:<5} | Entry: ${entry:>7.2f} | "
                ...
                if not data["orders"]:
                    ...
                    for order in data["orders"]:
                        ...
                        purpose = (
                            "🛑 STOP LOSS" if order_type == "STOP" else "🎯 TAKE PROFIT"
                        )

                        print(
                            f"   {symbol:<6} {side:<4} {qty:<3} | {order_type:<12} | "
                            f"{price:<15} | {purpose}"
                        )
                ...
                for pos in data["positions"]:
                    symbol_orders = [
                        o for o in data["orders"] if o.symbol == pos.symbol
                    ]
                    if symbol_orders:
