        ...
        html.Div(
            [
                ...
                html.Div(
                    [
                        html.H1(
                            "🚀 Interactive Scalping Bot Dashboard", className="header"
                        ),
                        html.P(
                            "Professional real-time trading analytics",
                ...
                html.Div(
                    [
                        html.Div(
                            [
                                html.Label(
                                    "📅 Days to Analyze:", style={"fontWeight": "bold"}
                                ),
                                dcc.Slider(
                                    id="days-slider",
                                    min=1,
                        ...
                        html.Div(
                            [
                                ...
                                dcc.Checklist(
                                    ...
                                    options=[
                                        {
                                            "label": " Exclude Aug 12 (No Risk Mgmt)",
                                            "value": "exclude",
                                        }
                                    ],
                                    value=["exclude"],
                        ...
                        html.Div(
                            [
                                html.Label(
                                    "🔄 Auto Refresh:", style={"fontWeight": "bold"}
                                ),
                                dcc.Interval(
                ...
                # Metrics Cards
                html.Div(
                    id="metrics-cards", className="row", style={"marginBottom": "30px"}
                ),
                # Main Charts Row
                html.Div(
                    [
                        html.Div(
                            [
                                html.Div(
                                    id="stock-performance-container",
                        ...
                        html.Div(
                            [
                                html.Div(
                                    id="timeline-container", className="chart-container"
                                )
                            ],
                            className="six columns",
                        ),
                ...
                html.Div(
                    [
                        ...
                        html.Div(
                            id="data-table-container", className="chart-container"
                        ),
                    ],
    ...
    try:
        ...
        status = html.Div(
            [
                ...
                html.Span(
                    f"🏆 {len([p for p in stock_pnl.values() if p > 0])}/{len(stock_pnl)} winners"
                    if stock_pnl
                    else "No data"
                ),
            ]
        ...
        error_msg = html.Div(
            f"❌ Error: {str(e)}", style={"color": "red", "textAlign": "center"}
        )
        return (
            error_msg,
            error_msg,
    ...
    return html.Div(
        [
            ...
            html.Div(
                [
                    html.H2(
                        f"${total_pnl:+,.2f}", style={"margin": "0", "fontSize": "24px"}
                    ),
            ...
            html.Div(
                [
                    html.H2(
                        f"{win_rate:.0f}%", style={"margin": "0", "fontSize": "24px"}
                    ),
                    html.P("Win Rate", style={"margin": "0", "fontSize": "14px"}),
                    html.P(
                        f"{winners}/{total_stocks} winners",
                        style={"margin": "0", "fontSize": "12px", "opacity": "0.8"},
                    ),
                ],
                className="three columns metric-card",
